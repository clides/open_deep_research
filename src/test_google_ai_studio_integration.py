...
async def test_google_ai_studio_integration():    
    ...
    config = {    
        "configurable": {    
            ...
            "research_model": "google:gemini-2.0-flash-lite",    
            ...
            "max_concurrent_research_units": 1,  # Reduced from 2 for rate limiting    
            "search_api": "tavily",    
            "max_researcher_iterations": 1,  # Reduced from 2 for rate limiting    
            "max_react_tool_calls": 3,  # Reduced from 5 for rate limiting    
                
            # Token limits - conservative for rate limiting    
            "research_model_max_tokens": 2000,  # Reduced from 4000    
            "compression_model_max_tokens": 2000,  # Reduced from 4000    
            "final_report_model_max_tokens": 2000,  # Reduced from 4000    
            "summarization_model_max_tokens": 1000,  # Reduced from 2000    
        }    
    }    
